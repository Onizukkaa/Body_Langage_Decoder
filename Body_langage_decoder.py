# -*- coding: utf-8 -*-
"""
Created on Tue May 24 15:16:48 2022
...
df = pd.read_csv("D:/programmation/Entrainement perso/Deep Learning/Body language decoder/coords.csv")
...
with open("body_langage.pkl", "wb") as f:
    pickle.dump(fit_models["rf"], f)

#%%
"""Make detections withe Model"""

with open("D:/programmation/Entrainement perso/Deep Learning/Body language decoder/body_langage.pkl", "rb") as f:
    model = pickle.load(f)
#%%  
cap = cv2.VideoCapture(0)
# Initiate holistic model
